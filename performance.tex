...
\begin{figure*}[!t]
    ...
    \caption{XXXXXPerformance of the continuous $r$-band morphology scores for the
...
XXXXXThe AUC is 0.871 for raw $\Delta m_r$, 0.899 for the morphology model without
...
XXXXXAt $16\leq r<24$, the probabilistic star-candidate sample has completeness
...
\begin{figure*}[!t]
    ...
    \caption{XXXXXCompleteness (top row) and purity (bottom row) of the
...
\begin{figure*}[!t]
    ...
    \caption{XXXXXRanking performance obtained from multiband morphology and color
...
XXXXXFor the star-positive comparison, the $ugrizy$ morphology AUC is 0.978,
...
XXXXXIncluding the color score changes the $ugrizy$ morphology AUC from 0.978 to
...
\begin{figure*}[!t]
    ...
    \caption{XXXXXColor--color distributions of the samples assigned to the unresolved
...
XXXXXClassifier-selected unresolved objects are plotted as blue points, while red
