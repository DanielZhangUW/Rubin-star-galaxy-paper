...
The morphological classification of resolved and unresolved sources\footnote{Note that quasars and
galaxies can be unresolved and even some stars can be resolved, such as Asymptotic Giant Branch stars.}, commonly
...
relatively simple, since stars outnumber galaxies and galaxies that exist are obviously extended on the sky.
...
The selection of clean faint stellar samples is especially hard. 
...
distribution in Rubin's Data Preview 1 catalogs, see Figure~28 in \cite{2026AJ....171..360V} or
Figure~\ref{fig:truth_morphology_color} further below). 
...
Furthermore, the binary nature of \texttt{extendedness} parameter prevents optimal combination of information from
...
using Rubin's Data Preview 2 data. We describe our dataset in \S 2, and in \S 3 discuss star-galaxy separation methodology,
including quantification of its performance using HST-based labels. We discuss our results and how
to retrieve our catalog with improved star-galaxy separation parameters in \S 4.  
