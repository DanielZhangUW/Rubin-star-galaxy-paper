...
Don't forget to talk about blind application of ML methods... Mention Random Forest tests...
Mention GP classifier with 5,000 simulated training observations
Muyskens et al. 2022: averaged over 100 simulation iterations: area under the curve is 0.985
 %    2022AJ....163..148M 

Don't forget: \ref{2021PASP..133e4502M} who modeled  dmag vs. mag using KDE

Mention griz\_model\_extendedness (Karlo's analysis)


Mention that if it works for stars at high Galactic latitude ($b \sim 50^\circ$), it should
work even better at lower latitudes. However, we may want to select a lower-latitude
field (say 15 deg or so) and rerun all notebooks with those data, too... 

Mention that both $\dm$ and $D$ fits are NOT universal: they depend on the sky location
and the depth of images! 
