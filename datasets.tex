...
counts as a function of magnitude are shown in Figure~\ref{fig:cosmos-magnitude-distribution}.
...
\begin{figure*}
 ...
 mixture of low-redshift quasars, white dwarfs and unresolved binaries. In the region with $24 < r
 < 24.5$ and $0.0<g-i<1.0$, galaxies outnumber stars by a factor of 80.}
...
\begin{figure*}
 ...
 In the region with $24 < r < 24.5$ and $0.0<g-i<1.0$, misclassied galaxies (bottom left panel)
 outnumber selected stars (top left panel) by a factor of 5.5.
}
...
We checked whether HST-labeled stars lie near the empirical COSMOS stellar
locus. For each source, we calculated its shortest distance to the locus using
five dereddened CModel colors: $(u-g,\,g-r,\,r-i,\,i-z,\,z-y)$. Because the
scatter in these colors changes with magnitude, we set a separate distance
threshold in each Rubin $r$-band CModel magnitude bin. Each threshold was set
to include at least 80\% of HST-labeled stars with measurements in all five
colors.

We excluded an HST-labeled star from the performance sample only when it was
both beyond the color threshold and classified as resolved by Rubin in the
$r$ band ($\mathrm{extendedness}_r=1$). This removed 836 of the 15,760
HST-labeled stars (5.30\%), leaving 14,924 (94.70\%). In the two magnitude
ranges of interest, the exclusions were 104 of 1,388 stars (7.49\%) at
$24<r<24.5$ and 116 of 1,700 stars (6.82\%) at $24.5<r<25$. Stars without the
measurements needed to check both criteria were not excluded by this
procedure.
...
\begin{figure*}
 ...
 10 arcsec (50x50 pixels), for a random subsample of 443 objects brighter than $r=23$ and
 selected as ``stars'' in HST and resolved in Rubin. About 98.6\% are detected as blended objects.} 
